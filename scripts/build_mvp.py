...
TEMPLATE_EXAMPLES = [
    {
        "company_id": "pvz-uab-betonas",
        "company_code": "123456789",
        "name": "UAB Pavyzdinė įmonė",
        "brand": "Pavyzdinis betonas",
        "city": "Vilnius",
        "municipality": "Vilniaus m. sav.",
        "address": "Gamyklos g. 1, Vilnius",
        "latitude": 54.6872,
        "longitude": 25.2797,
        "activity_type": "ready_mix_concrete",
        "activity_label": "Betono mišiniai",
        "concrete_plant_name": "Stetter",
        "concrete_plant_mixer": "2x3,35 m³",
        "concrete_plant_capacity": "100 m³/val.",
        "concrete_plant_silos_count": 2,
        "concrete_plant_description": "Trumpas viešai randamas mazgo arba gamyklos aprašymas.",
        "source_url": "https://imones-saltinis.lt/",
        "plant_source_url": "https://mazgo-saltinis.lt/",
        "manual_note": "Pastabos, ką dar reikia patikslinti.",
    },
    {
        "company_id": "pvz-betono-centras-vilnius",
        "company_code": "123018186",
        "name": "UAB Betono centras",
        "brand": "Betono centras",
        "city": "Vilnius",
        "municipality": "Vilniaus m. sav.",
        "address": "Naujoji Riovonių g. 11, Vilnius",
        "latitude": 54.6560815,
        "longitude": 25.2314767,
        "activity_type": "ready_mix_concrete",
        "activity_label": "Betono mišiniai",
        "concrete_plant_name": "Stetter",
        "concrete_plant_mixer": "2x3,35 m³",
        "concrete_plant_capacity": "100 m³/val.",
        "concrete_plant_silos_count": "Nenurodyta viešai",
        "concrete_plant_description": "Viešai skelbiamas Betono centro betono mazgas Vilniuje.",
        "source_url": "https://betonocentras.lt/kontaktai/",
        "plant_source_url": "https://betonocentras.lt/kontaktai/",
        "manual_note": "Pavyzdinė eilutė iš esamų duomenų; trūkstami techniniai duomenys pažymėti aiškiai.",
    },
    {
        "company_id": "pvz-betono-centras-klaipeda",
        "company_code": "123018186",
        "name": "UAB Betono centras",
        "brand": "Betono centras",
        "city": "Klaipėda",
        "municipality": "Klaipėdos m. sav.",
        "address": "Liepų g. 87N, Klaipėda",
        "latitude": 55.7290357,
        "longitude": 21.1544709,
        "activity_type": "ready_mix_concrete",
        "activity_label": "Betono mišiniai",
        "concrete_plant_name": "Klaipėdos betono mazgas",
        "concrete_plant_mixer": "Nenurodyta viešai",
        "concrete_plant_capacity": "Nenurodyta viešai",
        "concrete_plant_silos_count": "Nenurodyta viešai",
        "concrete_plant_description": "Viešai skelbiamas Betono centro betono mazgas Klaipėdoje.",
        "source_url": "https://betonocentras.lt/kontaktai/",
        "plant_source_url": "https://betonocentras.lt/kontaktai/",
        "manual_note": "Pavyzdinė eilutė iš esamų duomenų; parodyta, kaip pildyti eilutę, kai dalis techninių duomenų nerasta.",
    },
    {
        "company_id": "pvz-transdosa-druskininkai",
        "company_code": "Nenurodyta viešai",
        "name": "UAB Transdosa",
        "brand": "Transdosa",
        "city": "Druskininkai",
        "municipality": "Druskininkų sav.",
        "address": "Žvyro g. 2A, Margų k., Druskininkų sav.",
        "latitude": 54.146785,
        "longitude": 23.9291769,
        "activity_type": "ready_mix_concrete",
        "activity_label": "Betono mišiniai",
        "concrete_plant_name": "Elkomix-90 quick master",
        "concrete_plant_mixer": "1,5 m³",
        "concrete_plant_capacity": "40 m³/h",
        "concrete_plant_silos_count": 2,
        "concrete_plant_description": "Viešai skelbiamas betono mišinių tiekėjas Druskininkų regione.",
        "source_url": "https://www.transdosa.lt/kontaktai/",
        "plant_source_url": "https://www.transdosa.lt/betonas/",
        "manual_note": "Techniniai mazgo duomenys įrašyti pagal naudotojo pateiktą informaciją.",
    },
    {
        "company_id": "pvz-telsiu-keliai-telsiai",
        "company_code": "180200843",
        "name": "UAB Telšių keliai",
        "brand": "Telšių keliai",
        "city": "Telšiai",
        "municipality": "Telšių r. sav.",
        "address": "Mažeikių g. 18, Telšiai",
        "latitude": 56.0004158,
        "longitude": 22.2581129,
        "activity_type": "ready_mix_concrete",
        "activity_label": "Betono mišiniai",
        "concrete_plant_name": "Elkon",
        "concrete_plant_mixer": "Nenurodyta viešai",
        "concrete_plant_capacity": "Nenurodyta viešai",
        "concrete_plant_silos_count": 2,
        "concrete_plant_description": "Oficialiame įmonės puslapyje skelbiama betono mišinių gamyba ir prekyba.",
        "source_url": "https://www.tkeliai.lt/kitos-paslaugos/",
        "plant_source_url": "https://www.tkeliai.lt/kitos-paslaugos/",
        "manual_note": "Įtraukta pagal naudotojo informaciją; veikla patvirtinta oficialiame lietuviškame įmonės puslapyje.",
    },
]
...
def write_import_template() -> None:
    ...
    for example in TEMPLATE_EXAMPLES:
        ws.append([example.get(key, "") for key, _label in TEMPLATE_HEADERS])
    style_header(ws[1])
    ws.freeze_panes = "A2"
    ws.auto_filter.ref = ws.dimensions
